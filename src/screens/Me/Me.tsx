...
const Me = () => {
	...
	return (
		<ScreenLayout title='Software Developer'>
			<Main>
					...
					<Each>
						<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
							...
							<ChipContainer style={{ gap: 20 }}>
								...
								<a rel='noreferrer' target='_blank' href='https://www.linkedin.com/in/adiat-hasa'>
						...
						<Text>
							...
							<br />
							<br />
							Most of the time I work with Typescript, React & architecting the UI layer.
							<br />
							<br />
							Trying to write clean, reusable and scalable code that can easily be scaled in the future. Supporting
							use-cases is more fun to me while writing reusable code. Recently, I have gathered interest in open source
							projects and contributed to a few.
						</Text>
					</Each>
					<Each>
						...
						<Text>
							...
							2. Introducing Effortlessly scalable. Typesafe integrations with material UI inputs and react-hook-form.{' '}
							<br />
							3. Adapting React Query while replacingredux for server-side typesafe data management through apis. <br />
							4. Introducing the pattern for autogenerated custom hooks for typesafe data fetching and mutation. <br />
						...
						<Text>
							...
							2. Implemented scalable design patterns with vast control over the data layer. <br />
							3. Reactive development for the typesafe data layer with React Query. <br />
							4. Adapted advanced patterns for effortless integration of api's with autogenerated typesafe hooks. <br />
							5. Tech stack used: Node.js, Nest.js, React, Next.js, Typescript, React Query, Sass, Ant Design.
							<br />
						</Text>
						<ChipContainer>
							<Chip>Typescript</Chip>
				...
				<Sides colSpan='span 4'>
					<Each>
						...
						<Text style={{ margin: '12px 0' }}>
							<a href='https://linkedin.com/in/adiat-hasan'>linkedin.com/adiat-hasan</a>
						</Text>
						<Text style={{ margin: '12px 0' }}>
