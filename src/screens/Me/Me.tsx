			...
			<Main>
				<Sides colSpan='span 8'>
					<Each>
						<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
							...
							<ChipContainer style={{ gap: 20 }}>
								...
								<a rel='noreferrer' target='_blank' href='https://www.linkedin.com/in/adiat-hasan-1924681b0'>
						...
						<Text>
							...
							<br />
							<br />
							Most of the time I work with Typescript, React & architecting the UI layer. Firstly, I was more into
							building UIs. But over the time I got interested in writing clean, reusable and scalable code that can
							easily be scaled in the future. Supporting use-cases is more fun to me while writing reusable code.
							Recently, I got interested in open source projects and contributed to a few.
							<br />
							<br />
							I'm currently living with my wife, mother and my younger sister. Work life balance is the most significant
							way to keep me productive. Hence, I do so. Besides coding, I love to swim and play basketball, football.
						</Text>
					</Each>
					<Each>
						...
						<Text>
							Blue Tech is a software company providing solutions to the clients and has its own product called{' '}
							<a target='_blank' rel='noreferrer' href='https://bdtickets.com'>
								BD tickets
							</a>{' '}
							which is an online ticket platform. Previously there Bd tickets app was in plain react. Which was lagging
							in performance, SEO and UX as well. I was assigned to lead & architect the frontend of new BD tickets app
							which we rewrote in Next.js.
							<br />
						</Text>
						<ChipContainer>
						...
						<Text>
							...
							e-commerce product in Bangladesh and later globally. We are a small team of developers and it surely has a
							great environment for learning various technologies and leadership.
							<br />
						</Text>
						<ChipContainer>
							<Chip>Typescript</Chip>
						...
						<Text>
							Now in a logistics based company which mainly focused on delivery. I was appointed for building the entire
							UI of the Now client app. Having involvement in this project and completing it within the deadline was a
							challenging task to do. With the help of our Tech Lead we were able to deliver the product on time.
							<br />
						</Text>
						<ChipContainer>
							<Chip>Typescript</Chip>
					...
					<Each>
						...
						<Text>
							...
							approach in React.js applications. This simplifies contexts and reduces boiler plate code and has some
				...
				<Sides colSpan='span 4'>
					...
					<Each>
						...
						<br />
						<Subtitle>
							HTML, CSS, and Javascriptfor Web Developers(coursera) (08/2020 - 08/2020){' '}
							<a
								target='_blank'
								rel='noreferrer'
